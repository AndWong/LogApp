package com.logapp.log.services;
...
import com.logapp.log.Const;
import com.logapp.log.CrashHandler;
import com.logapp.log.R;
import com.logapp.log.activitys.LogActivity;
...
public class LogService extends Service {
    ...
    private void init() {
        LOG_PATH_MEMORY_DIR = getFilesDir().getAbsolutePath() + File.separator + "ZLLOG";
        LOG_SERVICE_LOG_PATH = LOG_PATH_MEMORY_DIR + File.separator + logServiceLogName;
        LOG_PATH_SDCARD_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "ZLLOG";
        createLogDir();
    ...
    private void startForeground() {
        ...
        mBuilder.setContentTitle("众联日志")//设置通知栏标题
                .setContentText("众联日志正在监控中...")
                //设置通知栏点击意图
